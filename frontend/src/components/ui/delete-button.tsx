...
export default function DeleteButton(props: DeleteProps) {
  ...
  const mutation = useApiMutation<DeleteRequest>({
    onSuccess: (res) => {
          ...
          <DialogContent className="w-125 max-h-[80vh] overflow-y-auto dark:bg-gray-900">
            <DialogHeader>
              ...
              <DialogDescription className="pt-4 text-gray-600 dark:text-gray-400">
                Are you sure you want to delete this {props.label}? This action
                cannot be undone.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4 py-4">
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground dark:text-gray-400">
                  Please provide a reason for deleting this record.
                </p>
              </div>
            </div>
            ...
            <DialogFooter>
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  disabled={mutation.isPending || !auditRemark.trim()}
