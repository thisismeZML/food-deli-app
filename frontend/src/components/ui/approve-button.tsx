...
export default function ApproveButton(props: ApproveProps) {
  const [open, setOpen] = useState(false);
  const [auditRemark, setAuditRemark] = useState("");
  const queryClient = useQueryClient();

  const mutation = useApiMutation<ApproveRequest>({
    onSuccess: (res) => {
          ...
          <DialogContent className="w-125 max-h-[80vh] overflow-y-auto dark:bg-gray-900">
            <DialogHeader>
              ...
              <DialogDescription className="pt-4 text-gray-600 dark:text-gray-400">
                Are you sure you want to approve this {props.label}? This action
                cannot be undone.
              </DialogDescription>
            </DialogHeader>
            <DialogFooter>
      ...
      <DialogContent className="w-125 max-h-[80vh] overflow-y-auto dark:bg-gray-900">
        ...
        <div className="space-y-4 py-4">
              <div className="space-y-2">
                <Label htmlFor="audit-remark" className="text-gray-700 dark:text-gray-300">
                  Audit Remark *
                </Label>
                <Input
                  id="audit-remark"
        ...
        <DialogFooter>
          <div className="flex gap-2">
            ...
            <Button
              ...
              onClick={handleApprove}
              disabled={mutation.isPending}
              className="bg-green-500 dark:bg-green-600 text-white hover:bg-green-600 dark:hover:bg-green-700 focus:ring-2 focus:ring-green-500 dark:focus:ring-green-600 focus:ring-offset-2 dark:focus:ring-offset-gray-900"
            >
              {mutation.isPending ? (
                <>
                  <LoadingButton />
